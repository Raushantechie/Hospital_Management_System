				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<div class="mb-3">
								...
								<label class="form-level">Full Name</label> <input required
							...
							<div class="mb-3">
								...
								<label class="form-level">Email address</label> <input required
									name="userId" type="email" class="form-control">
							</div>
							<div class="mb-3">
							...
							<buttton type="submit"
								class="btn bg-success text-white col-md-12">Register</buttton>
						</form>
					</div>
				</div>
			</div>
